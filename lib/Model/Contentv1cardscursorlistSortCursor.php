...
/**
 * Contentv1cardscursorlistSortCursor Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Contentv1cardscursorlistSortCursor implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'contentv1cardscursorlist_sort_cursor';
...
'limit' => 'getLimit'    ];
     ...
     * Sets updated_at
     *
     * @param string $updated_at Время обновления последней КТ из предыдущего ответа на запрос списка КТ.
     *
     * @return $this
     */
     ...
     * Sets nm_id
     *
     * @param int $nm_id Номенклатура последней КТ из предыдущего ответа на запрос списка КТ.
     *
     * @return $this
     */
