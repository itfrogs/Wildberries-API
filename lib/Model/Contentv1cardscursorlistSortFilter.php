...
/**
 * Contentv1cardscursorlistSortFilter Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Contentv1cardscursorlistSortFilter implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'contentv1cardscursorlist_sort_filter';
...
'with_photo' => 'getWithPhoto'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['with_photo'] = isset($data['with_photo']) ? $data['with_photo'] : null;
    }
     ...
     * Sets text_search
     *
     * @param int $text_search Поиск по номеру НМ или артикулу товара.
     *
     * @return $this
     */
     ...
     * Sets with_photo
     *
     * @param int $with_photo `-1` - Показать все КТ. <br>`0` - Показать КТ без фото. <br>`1` - Показать КТ с фото.
     *
     * @return $this
     */
