...
/**
 * CardsFilterBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CardsFilterBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'cards_filter_body';
     ...
     * Sets vendor_codes
     *
     * @param string[] $vendor_codes Массив идентификаторов НМ поставщика. <br>Максимальное количество в запросе `100`.
     *
     * @return $this
     */
