...
class InlineResponse20027 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'total' => 'int',
'orders' => '\Swagger\Client\Model\InlineResponse20027Orders[]'    ];
...
'orders' => 'getOrders'    ];
     ...
     * Sets total
     *
     * @param int $total Общее количество заказов по заданным параметрам (за указанный промежуток времени).
     *
     * @return $this
     */
     ...
     * Gets orders
     *
     * @return \Swagger\Client\Model\InlineResponse20027Orders[]
     */
     ...
     * Sets orders
     *
     * @param \Swagger\Client\Model\InlineResponse20027Orders[] $orders Список заказов.
     *
     * @return $this
     */
