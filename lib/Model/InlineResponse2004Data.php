...
'errors' => 'getErrors'    ];
     ...
     * Sets updated_at
     *
     * @param string $updated_at Дата и время запроса на создание КТ с данным НМ
     *
     * @return $this
     */
     ...
     * Sets errors
     *
     * @param string[] $errors Список ошибок из-за которых не обработался запрос на создание КТ с данным НМ
     *
     * @return $this
     */
