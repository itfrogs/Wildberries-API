...
/**
 * InlineResponse20028StickerWbStickerIdParts Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20028StickerWbStickerIdParts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_28_sticker_wbStickerIdParts';
...
'b' => 'getB'    ];
     ...
     * Sets a
     *
     * @param string $a Первая часть идентификатора этикетки (для печати подписи).
     *
     * @return $this
     */
     ...
     * Sets b
     *
     * @param string $b Вторая часть идентификатора этикетки.
     *
     * @return $this
     */
