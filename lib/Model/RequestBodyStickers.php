...
/**
 * RequestBodyStickers Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RequestBodyStickers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'requestBodyStickers';
     ...
     * Sets order_ids
     *
     * @param int[] $order_ids Идентификаторы сборочных заданий.
     *
     * @return $this
     */
