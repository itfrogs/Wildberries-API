...
/**
 * MediaSaveBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MediaSaveBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'media_save_body';
...
'data' => 'getData'    ];
     ...
     * Sets vendor_code
     *
     * @param string $vendor_code Артикул номенклатуры.
     *
     * @return $this
     */
     ...
     * Sets data
     *
     * @param string[] $data Ссылки на изображения в том порядке, в котором мы хотим их увидеть в карточке товара.
     *
     * @return $this
     */
