...
class DetailReportItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DetailReportItem';
...
'srid' => 'getSrid'    ];
    ...
    const DOC_TYPE_NAME_ = 'Продажа';
const DOC_TYPE_NAME__1 = 'Возврат';
...
self::DOC_TYPE_NAME__1,        ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['doc_type_name']) && !in_array($this->container['doc_type_name'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'doc_type_name', must be one of '%s'",
     ...
     * Sets sticker_id
     *
     * @param int $sticker_id Цифровое значение стикера, который клеится на товар в процессе сборки заказа по системе Маркетплейс.
     *
     * @return $this
     */
