...
/**
 * Apiv2ordersSgtin Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Apiv2ordersSgtin implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apiv2orders_sgtin';
...
'sid' => 'getSid'    ];
     ...
     * Sets code
     *
     * @param string $code Код маркировки на упаковке.
     *
     * @return $this
     */
     ...
     * Sets numerator
     *
     * @param int $numerator Числитель, количество единиц товара из упаковки (1, если продается целая упаковка).
     *
     * @return $this
     */
     ...
     * Sets denominator
     *
     * @param int $denominator Знаменатель, количество единиц товара в упаковке (1, если продается целая упаковка, т.е. для полной упаковки числитель = знаменатель = 1)
     *
     * @return $this
     */
     ...
     * Sets sid
     *
     * @param int $sid Идентификатор места деятельности субъекта обращения в ИС МДЛП.
     *
     * @return $this
     */
