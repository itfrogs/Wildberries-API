...
/**
 * CardsUpdateBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CardsUpdateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'cards_update_body';
...
'nm_id' => 'int',
'vendor_code' => 'string',
'sizes' => '\Swagger\Client\Model\Contentv1cardsupdateSizes[]',
...
'characteristics' => 'getCharacteristics'    ];
     ...
     * Sets imt_id
     *
     * @param int $imt_id Идентификатор карточки товара
     *
     * @return $this
     */
     ...
     * Gets sizes
     *
     * @return \Swagger\Client\Model\Contentv1cardsupdateSizes[]
     */
     ...
     * Sets sizes
     *
     * @param \Swagger\Client\Model\Contentv1cardsupdateSizes[] $sizes Массив размеров для номенклатуры (для безразмерного товара все равно нужно передавать данный массив с одним элементом и нулевым размером, но с ценой и баркодом)
     *
     * @return $this
     */
