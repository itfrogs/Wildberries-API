...
const MIME_TYPE_IMAGESVGXML = 'image/svg+xml';
...
self::MIME_TYPE_IMAGESVGXML,        ];
     ...
     * Sets mime_type
     *
     * @param string $mime_type Формат передаваемого файла.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Идентификатор поставки
     *
     * @return $this
     */
     ...
     * Sets file
     *
     * @param string $file Штрихкод поставки генерируется в формате code-128. Сам файл приходит в массиве байтов, закодированном в base64.
     *
     * @return $this
     */
