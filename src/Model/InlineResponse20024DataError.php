...
/**
 * InlineResponse20024DataError Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20024DataError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_24_data_error';
...
'err' => 'getErr'    ];
     ...
     * Sets err
     *
     * @param string $err Ошибка, случившаяся при загрудке остатка с данным баркодом.
     *
     * @return $this
     */
