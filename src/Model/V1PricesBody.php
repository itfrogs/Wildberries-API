...
/**
 * V1PricesBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1PricesBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1_prices_body';
...
'price' => 'getPrice'    ];
     ...
     * Sets price
     *
     * @param float $price Цена (указывать без копеек)
     *
     * @return $this
     */
