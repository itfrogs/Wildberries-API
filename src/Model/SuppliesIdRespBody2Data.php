...
/**
 * SuppliesIdRespBody2Data Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SuppliesIdRespBody2Data implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'suppliesIdRespBody2_data';
    ...
    {
        $this->container['failed_orders'] = isset($data['failed_orders']) ? $data['failed_orders'] : null;
    }
     ...
     * Sets failed_orders
     *
     * @param string[] $failed_orders Список заказов, которые не удалось обработать.
     *
     * @return $this
     */
