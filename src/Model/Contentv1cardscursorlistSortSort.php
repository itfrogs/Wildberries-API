...
/**
 * Contentv1cardscursorlistSortSort Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Contentv1cardscursorlistSortSort implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'contentv1cardscursorlist_sort_sort';
...
'ascending' => 'getAscending'    ];
     ...
     * Sets sort_column
     *
     * @param string $sort_column Поле по которому будет сортироваться список КТ (пока что поддерживается только `updatedAt`).
     *
     * @return $this
     */
     ...
     * Sets ascending
     *
     * @param bool $ascending Тип сортировки.
     *
     * @return $this
     */
